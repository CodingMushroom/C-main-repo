...
49. Подсчитать сумму числе в заданном числе (№28)
50. Вычисление произведения чисел от 1 до N (№29)
51. Показать кубы чисел, заканчивающихся на четную цифру (№30)
52. Задайте массив в 12 элементов, случайно заполненный числами из [-9;9]. Найти суммы отриц и полож значений (семинар)
